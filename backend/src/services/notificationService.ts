...
const transport = nodemailer.createTransport({
  ...
  auth: {
    user: process.env.SMTP_USER, // Para usarlo hay que agregar usuario y pass en el .env y descomentar
    pass: process.env.SMTP_PASS, // Para usarlo hay que agregar usuario y pass en el .env y descomentar
  },
});*/
