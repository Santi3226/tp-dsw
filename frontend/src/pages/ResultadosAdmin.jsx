...
import TabResultadoFiltrar from '../components/tabsAdmins/Resultados/TabResultadoFiltrar';
import TabResultadoCargar from '../components/tabsAdmins/Resultados/TabResultadoCargar';
						...
						<tbody>
							{turnosFiltrados.map((turno) => (
								<tr key={turno.id}>
									...
									<td>
										{new Date(turno.fechaHoraExtraccion).toLocaleDateString() !==
										'31/12/1969, 09:00:00'
											? new Date(turno.fechaHoraExtraccion).toLocaleDateString()
											: '-'}
									</td>
